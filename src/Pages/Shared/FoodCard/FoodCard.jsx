const FoodCard = ({ item }) => {
       ...
       return (
              <div className="shadow-lg border border-black border-opacity-30 dark:border dark:border-white bg-[#F3F3F3] dark:bg-black dark:bg-opacity-25 px-5 py-7 rounded-xl relative flex flex-col h-full">
